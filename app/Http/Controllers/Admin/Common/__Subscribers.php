	...
	public function index( Request $request ) {
		...
		if ( $request->has( 'excel' ) && $request->excel == 'excel' ) {
			...
			if ( count( $all_subscriber ) > 0 ) {
				Excel::create( 'doodle_digital_subscribers_' . date( 'YmdHis' ), function ( $excel ) use ( $all_subscriber ) {
...
// Set borders with array
						...
						$single   = [];
						$single[] = 'Doodle Digital Subscribers';
				...
				return view( "sm-admin/common/subscriber/manage_subscriber", $data );
			}
		} else {
			return view( "sm-admin/common/subscriber/manage_subscriber", $data );
		}
	...
	public function create() {
		...
		return view( "sm-admin/common/subscriber/add_subscriber", $data );
	}
...
//	}
	...
	public function edit( $id ) {
		...
		if ( count( $data['subscriber_info'] ) > 0 ) {
			...
			return view( 'sm-admin/common/subscriber/edit_subscriber', $data );
		} else {
			return redirect( SM::smAdminSlug( "subscribers" ) )
