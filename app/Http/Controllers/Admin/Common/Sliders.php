...
class Sliders extends Controller
{
	function sliders()
	{
		...
		if (\request()->ajax()) {
			$json['data']         = view('sm-admin/common/slider/slider_list', $data)->render();
		...
		return view('sm-admin/common/slider/sliders', $data);
	}
	...
	function add_slider()
	{
		...
		return view('sm-admin/common/slider/add_slider', $data);
	}
	...
	function edit_slider($id)
	{
		...
		return view('sm-admin/common/slider/edit_slider', $data);
	}
