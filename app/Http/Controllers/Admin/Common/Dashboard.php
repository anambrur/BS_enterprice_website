...
class Dashboard extends Controller {
	public function index() {
		...
		return view( 'sm-admin/common/dashboard/dashboard', $data );
	}

	public function access_denied() {
		return view( 'sm-admin/common/dashboard/access_denied' );
	}
	...
	public function edit_profile() {
		...
		return view( 'sm-admin/common/dashboard/edit_user', $data );
	}
	...
	function profile() {
		return view( 'sm-admin/common/dashboard/profile' );
	}
}
