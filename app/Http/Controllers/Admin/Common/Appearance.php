...
class Appearance extends Controller {
	...
	public function smThemeOptions() {
		...
		return view( 'sm-admin/common/appearance/sm-theme-options', [
	...
	function menus() {
		...
		return view( 'sm-admin/common/appearance/menus', $data );
	}
	...
	public function editor( Request $request ) {
		if ( $request->ajax() ) {
			 ...
			 */
			return view( 'sm-admin/common/appearance/editor/editor' );
		}
	}
	...
	private function getFileIcon( $ext ) {
		...
		return asset( 'sm-admin/img/file_icon/' . $icon );
	}
