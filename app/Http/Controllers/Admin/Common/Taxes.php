...
class Taxes extends Controller {
	...
	public function index() {
		...
		if ( \request()->ajax() ) {
			$json['data']       = view( 'sm-admin/common/tax/taxes', $data )->render();
		...
		return view( "sm-admin/common/tax/manage_tax", $data );
	}
	...
	public function create() {
		...
		return view( "sm-admin/common/tax/add_tax", $data );
	}
...
//	}
	...
	public function edit( $id ) {
		...
		if ( count( $data["tax_info"] ) > 0 ) {
			...
			return view( "sm-admin/common/tax/edit_tax", $data );
		} else {
			return redirect( SM::smAdminSlug( 'taxes' ) )
	...
	public function update( Request $request, $id ) {
		...
		if ( count( $tax ) > 0 ) {
			...
			return redirect( SM::smAdminSlug( 'taxes' ) )
				->with( 's_message', 'Tax updated successfully!' );
		} else {
			return redirect( SM::smAdminSlug( 'taxes' ) )
