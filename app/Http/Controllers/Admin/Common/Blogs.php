...
class Blogs extends Controller {
	...
	public function index() {
		...
		if ( \request()->ajax() ) {
			$json['data']         = view( 'sm-admin/common/blog/blogs', $data )->render();
		...
		return view( "sm-admin/common/blog/manage_blog", $data );
	}
	...
	public function create() {
		...
		return view( "sm-admin/common/blog/add_blog", $data );
	}
	...
	public function store( Request $request ) {
		...
		if ( SM::is_admin() || isset( $permission ) &&
		                       isset( $permission['blogs']['blog_status_update'] )
		                       && $permission['blogs']['blog_status_update'] == 1 ) {
...
//	}
	...
	public function edit( $id ) {
		...
		// if ( count( $data["blog_info"] ) > 0 ) {
			...
			return view( "sm-admin/common/blog/edit_blog", $data );
		} else {
	...
	public function comments() {
		...
		if ( \request()->ajax() ) {
			$json['data']         = view( 'sm-admin/common/blog/comments', $data )->render();
			$json['smPagination'] = view( 'sm-admin/common/common/pagination_links', [
		...
		return view( "sm-admin/common/blog/manage_comments", $data );
	}
	...
	public function edit_comment( $id ) {
		...
		return view( "sm-admin/common/blog/edit_comment", $data );
	}
	...
	public function update_comment( Request $request, $id ) {
		...
		if ( !empty( $comment ) ) {
			...
			if ( SM::is_admin() || isset( $permission ) &&
			                       isset( $permission['blogs']['comment_status_update'] )
			                       && $permission['blogs']['comment_status_update'] == 1 ) {
	...
	public function reply_comment( $id ) {
		...
		return view( "sm-admin/common/blog/reply_comment", $data );
	}
	...
	public function save_reply( Request $request ) {
		...
		if ( $blog ) {
			...
			if ( SM::is_admin() || isset( $permission ) &&
			                       isset( $permission['blogs']['reply_comment'] )
			                       && $permission['blogs']['reply_comment'] == 1 ) {
				$comment->status = $request->status;
			}
			$comment->save();
