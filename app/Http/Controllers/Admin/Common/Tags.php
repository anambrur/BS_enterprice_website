...
class Tags extends Controller {
	...
	public function index() {
		...
		if ( \request()->ajax() ) {
			$json['data']         = view( 'sm-admin/common/tag/tags', $data )->render();
		...
		return view( "sm-admin/common/tag/manage_tag", $data );
	}
	...
	public function create() {
		...
		return view( "sm-admin/common/tag/add_tag", $data );
	}
...
//	}
	...
	public function edit( $id ) {
		...
		if ( count( $data['tag_info'] ) > 0 ) {
			...
			return view( 'sm-admin/common/tag/edit_tag', $data );
		} else {
			return redirect( SM::smAdminSlug( "tags" ) )
