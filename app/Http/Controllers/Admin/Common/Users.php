...
class Users extends Controller {
	...
	public function index() {
		...
		if ( \request()->ajax() ) {
			$json['data']         = view( 'sm-admin/common/users/users', $data )->render();
		...
		return view( 'sm-admin/common/users/manage_user', $data );
	}

	public function add_user() {
		$data['roles'] = Role::where( "status", 1 )->get();
		return view( 'sm-admin/common/users/add_user', $data );
	}
	...
	public function edit_user( $id ) {
		...
		return view( 'sm-admin/common/users/edit_user', $data );
	}
	...
	public function roles() {
		...
		if ( \request()->ajax() ) {
			$json['data']         = view( 'sm-admin/common/users/roles_list', $data )->render();
			$json['smPagination'] = view( 'sm-admin/common/common/pagination_links', [
		...
		return view( 'sm-admin/common/users/manage_roles', $data );
	}

	public function add_role() {
		$data['role'] = array();

		return view( 'sm-admin/common/users/add_role', $data );
	}
	...
	public function edit_role( $id ) {
		...
		return view( 'sm-admin/common/users/edit_role', $data );
	}
