...
class Customers extends Controller {
    ...
    public function index(Request $request) {
        ...
        if ($request->ajax()) {
            $json['data'] = view('sm-admin/common/customers/customers', $data)->render();
        ...
        return view('sm-admin/common/customers/manage_user', $data);
    }
    ...
    public function add_customer() {
        ...
        return view('sm-admin/common/customers/add_user', $data);
    }
...
//			'password'  => 'required|confirmed|min:6',
        ...
        $user->contact_person = isset($data['contact_person']) ? $data['contact_person'] : null;
        $user->contact_mobile = isset($data['contact_mobile']) ? $data['contact_mobile'] : null;
        $user->vat = isset($data['vat']) ? $data['vat'] : null;
        ...
        if (SM::is_admin() || isset($permission) &&
                isset($permission['customers']['customer_status_update']) && $permission['customers']['customer_status_update'] == 1) {
    ...
    public function edit_customer($id) {
        ...
        return view('sm-admin/common/customers/edit_user', $data);
    }
