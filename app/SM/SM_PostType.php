...
class ' . self::$namePlural . ' extends Controller {
	...
	public function index() {
		...
		if ( \request()->ajax() ) {
			$json[\'data\']         = view( \'sm-admin/common/' . self::$nameL . '/' . self::$namePluralL . '\', $data )->render();
		...
		return view( "sm-admin/common/' . self::$nameL . '/manage_' . self::$nameL . '", $data );
	}
	...
	public function create() {
		...
		return view( "sm-admin/common/' . self::$nameL . '/add_' . self::$nameL . '", $data );
	}
...
//	}
	...
	public function edit( $id ) {
		...
		if ( count( $data[\'' . self::$nameL . '_info\'] ) > 0 ) {
			...
			return view( \'sm-admin/common/' . self::$nameL . '/edit_' . self::$nameL . '\', $data );
		} else {
			return redirect( SM::smAdminSlug( "' . self::$namePluralL . '" ) )
