                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                            ...
                            <table id="manage_blog" class="table table-striped table-bordered data_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                <?php echo $__env->make('sm-admin.common.category.categories', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </tbody>
                                
                            </table>
                            <?php echo $__env->make('sm-admin.common.common.pagination_links', ['smPagination'=>$all_category], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
