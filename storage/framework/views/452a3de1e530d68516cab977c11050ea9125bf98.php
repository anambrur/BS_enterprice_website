    ...
    <div class="jarviswidget" id="wid-add-category-main" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <div class="col-sm-12">
                        <?php echo $__env->make("sm-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'categories'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="col-sm-12">
        ...
        <div>
            ...
            <div class="widget-body padding-10">              
                ...
                <div class="form-group<?php echo e($errors->has('category_type') ? ' has-error' : ''); ?>">
                    <?php echo Form::label('category_type', 'Category Type'); ?>

                    <?php echo Form::select('category_type',['1'=>'Product','2'=>'Gallery'],null,['class'=>'form-control']); ?>
...
?>
<?php echo $__env->make('sm-admin/common/common/image_form',['header_name'=>'Category',
'image'=>$image], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('sm-admin/common/common/meta_info',['header_name'=>'Category',
