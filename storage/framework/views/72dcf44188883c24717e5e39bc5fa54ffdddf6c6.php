...
<head>
    ...
    <link rel="apple-touch-icon" sizes="120x120"
        href="<?php echo e(asset('sm-admin/img/splash/touch-icon-iphone-retina.png')); ?>">
...
<body class="smart-style-1">
    ...
    <header id="header">
        ...
        <div class="pull-right">
            ...
            <div id="" class="btn-header pull-right">
                <span> <a href="<?php echo e(url('')); ?>" title="View site" target="_blank"><i class="fa fa-eye"></i></a>
                </span>
            </div>
            ...
            <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
                <li class="">
                    <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                        ...
                        ?>
                        <img src="<?php echo SM::sm_get_the_src($currentUserImage, 30, 30); ?>" alt="<?php echo e($current_user_first_lastname); ?>" class="online" />
                    </a>
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="<?php echo e(url(SM::smAdminSlug('logout'))); ?>"
                ...
                <div class="col-xs-12 col-sm-6 col-lg-8">
                    <div id="smddtech_ads">
                        ...
                        <?php if(isset($rightButton['text']) && isset($rightButton['link'])): ?>
                            <a href="<?php echo e(url(SM::smAdminSlug($rightButton['link']))); ?>"
    ...
    <script data-pace-options='{ "restartOnRequestAfter": true }' src="<?php echo e(asset('sm-admin/js/plugin/pace/pace.min.js')); ?>">
    </script>
