        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6 order-2 order-lg-1">
                <div class="about-content wow slideInLeft">
                    <h3><?php echo e($seo_marketing_title); ?></h3>
                    <p><?php echo str_limit($seo_marketing_description, 400); ?></p> 
                    <a href="<?php echo e(url('/about')); ?>" class="readMoreBtn btn">
                        Read More
                    </a>
                </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 order-1 order-lg-2">
                <div class="video-box ml-0 ml-xl-5 wow slideInRight" data-tilt>
                    <div class="video-box-thumb">
                        <img src="<?php echo SM::sm_get_the_src($seo_video_banner, 622, 360); ?>" alt="<?php echo e($seo_marketing_title); ?>">
                    </div>
                    
                    
                    
                    <a href="<?php echo e($seo_video_youtube_link); ?>" class="play-button">
