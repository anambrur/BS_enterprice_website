...
<?php $__env->startSection('content'); ?>
    <div class="well no-padding">
        <form class="smart-form client-form" id="smart-form-register"  role="form" method="POST" action="<?php echo e(url(config('constant.smAdminSlug').'/register')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <fieldset>
                ...
                <section>
                    <label class="input<?php echo e($errors->has('username') ? ' state-error' : ''); ?>">
                        <i class="icon-append fa fa-user"></i>
                        <input type="text" class="<?php echo e($errors->has('username') ? 'invalid' : ''); ?>" name="username" placeholder="Username" value="<?php echo e(old('username')); ?>">
                        <b class="tooltip tooltip-bottom-right">Enter your username</b> </label>
                    <?php if($errors->has('username')): ?>
                        <em class="invalid" for="username"><?php echo e($errors->first('username')); ?></em>
                    <?php endif; ?>
                </section>
                ...
                <section>
                    <label class="input<?php echo e($errors->has('password') ? ' state-error' : ''); ?>">
                        <i class="icon-append fa fa-lock"></i>
                        <input type="password" name="password" class="<?php echo e($errors->has('password') ? ' invalid' : ''); ?>" placeholder="Password" id="password" value="<?php echo e(old('password')); ?>">
                        <b class="tooltip tooltip-bottom-right">Enter your password (Min 6 character's)</b> </label>
                    <?php if($errors->has('password')): ?>
                        <em class="invalid" for="password"><?php echo e($errors->first('password')); ?></em>
                    <?php endif; ?>
                </section>
            ...
            <fieldset>
                <div class="row">
                    <section class="col col-6">
                        <label class="input<?php echo e($errors->has('firstname') ? ' state-error' : ''); ?>">
                            <input type="text" class="<?php echo e($errors->has('firstname') ? ' invalid' : ''); ?>" name="firstname" placeholder="First name" value="<?php echo e(old('firstname')); ?>">
                        </label>
                        <?php if($errors->has('firstname')): ?>
                            <em class="invalid" for="firstname"><?php echo e($errors->first('firstname')); ?></em>
                        <?php endif; ?>
                    </section>
                    <section class="col col-6">
                        <label class="input<?php echo e($errors->has('lastname') ? ' state-error' : ''); ?>">
                            <input type="text" class="<?php echo e($errors->has('lastname') ? ' invalid' : ''); ?>" name="lastname" placeholder="Last name" value="<?php echo e(old('lastname')); ?>">
                        </label>
                        <?php if($errors->has('lastname')): ?>
                            <em class="invalid" for="lastname"><?php echo e($errors->first('lastname')); ?></em>
                        <?php endif; ?>
                    </section>
                </div>
                ...
                <div class="row">
                    <section class="col col-6" >
                        <label class="select<?php echo e($errors->has('gender') ? ' state-error' : ''); ?>" >
                            <select name="gender" class="<?php echo e($errors->has('gender') ? ' invalid' : ''); ?>" >
                        ...
                        <?php if($errors->has('gender')): ?>
                            <em class="invalid" for="email"><?php echo e($errors->first('gender')); ?></em>
                        <?php endif; ?>
                    </section>
                    <section class="col col-6">
                        <label class="input"> <i class="icon-append fa fa-calendar"></i>
                            <input type="text" name="request" placeholder="Request activation on" class="datepicker" data-dateformat='dd/mm/yy'  value="<?php echo e(old('request')); ?>">
                        </label>
                    </section>
                </div>
                ...
                <section>
                    <label class="checkbox">
                        <input type="checkbox" name="subscription" value="1" id="subscription" <?php echo e(old('subscription')==1? 'checked':''); ?>>
                        <i></i>I want to receive news and special offers</label>
                    <label class="checkbox<?php echo e($errors->has('terms') ? ' state-error' : ''); ?>">
                        <input type="checkbox" class="<?php echo e($errors->has('terms') ? ' invalid' : ''); ?>" name="terms" id="terms" value="1"  <?php echo e(old('terms')==1? 'checked':''); ?>>
                        <i></i>I agree with the <a href="#" data-toggle="modal" data-target="#myModal"> Terms and Conditions </a></label>
                    <?php if($errors->has('terms')): ?>
                        <em class="invalid" for="terms"><?php echo e($errors->first('terms')); ?></em>
                    <?php endif; ?>
                </section>
            </fieldset>
            <footer>
