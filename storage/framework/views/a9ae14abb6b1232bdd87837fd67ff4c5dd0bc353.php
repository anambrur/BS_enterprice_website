...
<head>
  ...
  <title> <?php echo $__env->yieldContent('title'); ?> <?php echo SM::sm_get_site_name(); ?></title>
  ...
  <!-- Favicons -->
  <link rel="shortcut icon" href="<?php echo e(SM::sm_get_the_src( SM::sm_get_site_favicon(), 30, 30 )); ?>" type="image/x-icon">
  <link rel="icon" href="<?php echo e(SM::sm_get_the_src( SM::sm_get_site_favicon(), 30, 30 )); ?>" type="image/x-icon">
  ...
  <?php
         ...
         ?>
  <?php echo $__env->make('frontend.includes.css', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<body>
  <div class="wrapper" id="wrapper">
    ...
    <?php echo $__env->make('frontend.common.auth', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('frontend.includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!--// Header Style 3 -->
    <?php echo $__env->make('frontend.page.s_w_message', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <!-- //Main wrapper -->
  <!-- js -->
  <?php echo $__env->make('frontend.includes.js', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
