                ...
                <div class="col-lg-3 col-md-3 col-12">
                    <div class="header-iconline text-left">
                        <ul class="navbar-right">
                            <li>
                                <a href="tel:<?php echo e(SM::get_setting_value('mobile')); ?>">
                                    <i class="fa fa-phone"></i><?php echo e(SM::get_setting_value('mobile')); ?>
                    ...
                    <div class="header-inner">
                        <div class="logo">
                            <a href="<?php echo e(url('/')); ?>">
                                <img src="<?php echo e(SM::sm_get_the_src( SM::get_setting_value( 'logo' ) )); ?>" alt="<?php echo e(SM::get_setting_value('site_name')); ?>">
                            </a>
                        </div>
                        <nav class="menu">
                            <?php
    ...
    <div class="mobile-menu-wrapper">
        <div class="container d-block d-lg-none">
            <div class="mobile-menu clearfix">
                <a class="mobile-logo" href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(SM::sm_get_the_src( SM::get_setting_value( 'logo' ) )); ?>" alt="<?php echo e(SM::get_setting_value('site_name')); ?>" alt="<?php echo e(SM::get_setting_value('site_name')); ?>">
                </a> 
            </div>
        </div>
    </div>
