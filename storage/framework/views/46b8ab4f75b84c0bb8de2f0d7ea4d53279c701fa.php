                                    ...
                                    <div class="panel-group smart-accordion-default" id="accordion-2">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion-2"
                                                       href="#acc_packages" class="collapsed">
                                                        <i class="fa fa-fw fa-plus-circle txt-color-green"></i>
                                                        <i class="fa fa-fw fa-minus-circle txt-color-red"></i>
                                                        Packages </a>
                                                </h4>
                                            </div>
                                              <div id="acc_packages" class="panel-collapse collapse">
                                                <div class="panel-body">

                                                    <div class="smart-form add_custom_menu" id="add_service_div">  
                                                        <?php if(isset($packages) && count($packages)>0): ?>
                                                            <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <label class="checkbox">
                                                                    ...
                                                                    <i></i>
                                                                    <input type="hidden" id="page_checkbox_<?php echo e($i); ?>"
                                                                           value="/packages/<?php echo e($package->slug); ?>"
                                                                           menu_title="<?php echo e($package->title); ?>"
                                                                           menu_type="page">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h4 class="panel-title">
                                                    <a data-toggle="collapse" data-parent="#accordion-2"
                                                       href="#acc_services" class="collapsed">
                                                        <i class="fa fa-fw fa-plus-circle txt-color-green"></i>
                                                        <i class="fa fa-fw fa-minus-circle txt-color-red"></i>
                                                        Services </a>
                                                </h4>
                                            </div>
                                            <div id="acc_services" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                        ...
                                                        <?php if(isset($services) && count($services)>0): ?>
                                                            <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <label class="checkbox">
                                                                    ...
                                                                    <i></i>
                                                                    <input type="hidden" id="page_checkbox_<?php echo e($i); ?>"
                                                                           value="/services/detail/<?php echo e($service->slug); ?>"
                                                                           menu_title="<?php echo e($service->title); ?>"
                                                                           menu_type="page">
                                                    ...
                                                    <div class="smart-form add_custom_menu">
                                                        ...
                                                        <label class="input">
                                                            ...
                                                            <input type="text" id="add_custom_menu_link"
                                                                   placeholder="Url like http://smddtech.com"
                                                                   class="form-control">
                                                        </label>
                                                        <div class="clearfix"></div>
                                                        <br>
