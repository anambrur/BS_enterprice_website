    ...
    <div class="jarviswidget" id="" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <div class="col-sm-12">
                        <?php echo $__env->make("sm-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'products'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="col-sm-12">
                        <div class="sm-form<?php echo e($errors->has('batch_no') ? ' has-error' : ''); ?>">
                            <?php echo Form::label('batch_no',__("Application")); ?>

                            <?php echo Form::text('batch_no', null,['required'=>'','class'=>'form-control', 'placeholder'=>__("Application")]); ?>

                            <?php if($errors->has('batch_no')): ?>
                            <span class="help-block">
                                <strong><?php echo e($errors->first('batch_no')); ?></strong>
                            </span>
                            <?php endif; ?>
                        </div>
                    </div>
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                ...
                <div class="form-group <?php echo e($errors->has('category_id') ? ' has-error' : ''); ?>">
                    ...
                    ?>
                    <?php echo Form::select('category_id',$cat_select_array,null,['class'=>'form-control']); ?>
...
?>
<?php echo $__env->make('sm-admin/common/common/image_form',['header_name'=>'Product',
