...
@section('content')
    ...
    <script src="{{asset('sm-admin/js/plugin/flot/jquery.flot.cust.min.js')}}"></script>
    <script src="{{asset('sm-admin/js/plugin/flot/jquery.flot.resize.min.js')}}"></script>
    <script src="{{asset('sm-admin/js/plugin/flot/jquery.flot.tooltip.min.js')}}"></script>
	<?php
