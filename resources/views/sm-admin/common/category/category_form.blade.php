    ...
    <div class="jarviswidget" id="wid-add-category-main" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <div class="col-sm-12">
                        @include("sm-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'categories'])
                    </div>
                    <div class="col-sm-12">
        ...
        <div>
            ...
            <div class="widget-body padding-10">              
                ...
                <div class="form-group{{ $errors->has('category_type') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('category_type',['1'=>'Product','2'=>'Gallery'],null,['class'=>'form-control']) !!}
...
?>
@include('sm-admin/common/common/image_form',['header_name'=>'Category',
'image'=>$image])
@include('sm-admin/common/common/meta_info',['header_name'=>'Category',
'width'=>'col-lg-12'])