...
@section("header_style")
    <link rel="stylesheet" href="{{ asset('sm-admin/js/plugin/jstree/themes/default/style.min.css') }}"/>
@endsection
@section("footer_script")
    <script src="{{ asset('sm-admin/js/plugin/jstree/jstree.min.js') }}"></script>
    <script src="{{ asset('sm-admin/js/plugin/ace-editor/ace.js') }}"></script>
