            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                >
                    ...
                    <header>
                        ...
                        <button type="button" class="btn btn-default pull-right sm_theme_option_save" id="sm_theme_option_save"><i class="fa fa-save"></i> Save</button>
                    </header>
                    ...
                    <div>
                        ...
                        <div class="widget-body no-padding smthemeoptions">
                            ...
                            <div class="col-sm-12 text-right">
                                <button type="button" class="btn btn-primary margin-bottom-10  margin-top-10 sm_theme_option_save" id="sm_theme_option_save"><i class="fa fa-save"></i> Save</button>
                                <a class="btn btn-primary btn-danger"
                                   href="{!! url(SM::smAdminSlug("flush-cache")) !!}">
                                    <i class="fa fa-trash-o"></i>
                                    Flush Cache
                                </a>
                                <button type="button" class="btn btn-default margin-bottom-10  margin-top-10 sm_theme_option_move_to_top" id="sm_theme_option_save"><i class="fa fa-arrow-up"></i> Move To Top</button>
                            </div>
                            {!! Form::close() !!}
                        </div>
                        <!-- end widget content -->
