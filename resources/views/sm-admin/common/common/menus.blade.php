...
<nav id="admin_main_nav">
    ...
    <ul>
        ...
        <li ctrl="blogs">
            ...
            <ul>
                ...
                <li mtd="create">
                    <a href="{{url(SM::smAdminSlug('blogs/create'))}}">
                        Add Blogs
                    </a>
                </li>
                </?php endif; ?>
                ...
                <li mtd="index">
                    <a href="{{url(SM::smAdminSlug('blogs'))}}">
                        Blogs List
                    </a>
                </li>
                </?php endif; ?>
        ...
        <!--        <li mtd="create">-->
        <!--            <a href="{{url(SM::smAdminSlug('packages/create'))}}">Add Package</a>-->
        <!--        </li>-->
        <!--        <?php endif; ?>-->
        <!--        <?php if (SM::check_this_method_access('packages', 'index')): ?>-->
        <!--        <li mtd="index">-->
        <!--            <a href="{{url(SM::smAdminSlug('packages'))}}">All Package</a>-->
        <!--        </li>-->
        <!--        <?php endif; ?>-->
        <!--    </ul>-->
        <!--</li>-->
    ...
    <!-- /Portfolio -->
     <?php if (SM::check_this_contoller_access('careers')): ?>
       ...
       <!--     <a href="{{url(url(SM::smAdminSlug('careerapplys')))}}" title="Media"><i class="fa fa-lg fa-fw fa-tasks"></i>-->
       ...
       <!--<li ctrl="orders">-->
       <!--     <a href="{{url(url(SM::smAdminSlug('orders')))}}" title="Media"><i class="fa fa-lg fa-fw fa-shopping-cart"></i>-->
       ...
       <!--<li ctrl="contacts">-->
       <!--     <a href="{{url(url(SM::smAdminSlug('contacts')))}}" title="Media"><i class="fa fa-lg fa-fw fa-phone"></i>-->
    ...
    <!-- Subscribers -->
     <!--<li ctrl="subscribers">-->
     <!--       <a href="{{url(url(SM::smAdminSlug('subscribers')))}}" title="Media"><i class="fa fa-lg fa-fw fa-users"></i>-->
     ...
     <!--   </li>-->
        ...
        <!--        <li mtd="create">-->
        <!--            <a href="{{url(SM::smAdminSlug('services/create'))}}">-->
        <!--                Add Services-->
        <!--            </a>-->
        <!--        </li>-->
        <!--        <?php endif; ?>-->
        ...
        <!--        <li mtd="index">-->
        <!--            <a href="{{url(SM::smAdminSlug('services'))}}">-->
        <!--                Services List-->
        <!--            </a>-->
        <!--        </li>-->
        <!--        <?php endif; ?>-->
