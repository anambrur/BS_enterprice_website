  ...
  <div>
    ...
    <div class="widget-body padding-10 image-popup-body">
      <div class="form-group">
       ...
       <input type="hidden" name="{{ $input_holder }}" id="{{ $input_holder }}" value="{{ str_replace('"', '', $image_gallery) }}" />
       <input input_holder="{{ $input_holder }}" img_holder="{{ $img_holder }}" is_multiple media_width="112" img_width="100"
