    ...
    <div class="jarviswidget" id="wid-add-tag-main" data-widget-editbutton="false"
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <div class="col-sm-12">
                        @include("sm-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'tags'])
                    </div>
                    <div class="col-sm-12">
...
?>
@include('sm-admin/common/common/image_form',['header_name'=>'Tag',
'image'=>$image])
@include('sm-admin/common/common/meta_info',['header_name'=>'Tag',
'width'=>'col-lg-12'])