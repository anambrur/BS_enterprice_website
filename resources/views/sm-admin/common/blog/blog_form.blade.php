    ...
    <div class="jarviswidget" id="wid-add-blog-main" data-widget-editbutton="false" data-widget-deletebutton="false">
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    <div class="col-sm-12">
                        @include("sm-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'blogs'])
                    </div>
...
@include('sm-admin/common/common/meta_info', ['header_name'=>'Blog', 'width'=>'col-lg-8'])
<?php
if ( old( 'image' ) ) {
	$image = old( 'image' );
...
?>
@include('sm-admin/common/common/image_form',['header_name'=>'Blog', 'image' => $image])