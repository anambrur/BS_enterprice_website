...
@section('content')
    ...
    <section id="widget-grid" class="">
        ...
        <div class="row">
            ...
            <form style="display: none" name="cache_setting" id="save_cache_setting" method="post"
            ...
            <!-- NEW WIDGET START -->
                <article class="col-xs-12 col-sm-4">
                    ...
                    <!-- Widget ID (each widget will need unique ID)-->
                    <div class="jarviswidget" id="wid-cache-setting" style="">
                        <!-- widget options:
                           usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <label class="toggle">
											...
											<?php  $is_cache_enable = SM::get_setting_value( 'is_cache_enable', 1 );
            ...
            <form style="display: none" name="tax_setting" id="save_tax_setting" method="post"
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-8">
                                        <label class="toggle">
											...
											<?php  $is_tax_enable = SM::get_setting_value( 'is_tax_enable' );
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-10">
                                        <label class="toggle">
											...
											<?php  $is_maintenance_enable = SM::get_setting_value( 'is_maintenance_enable' );
