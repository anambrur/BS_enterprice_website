...
<article class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
    ...
    <div class="jarviswidget" id="wid-id-package-publish" data-widget-editbutton="false"
        ...
        <div>
            ...
            <!-- widget content -->
            <div class="widget-body padding-10">
                <div class="sm-form form-group {{ $errors->has('categories') ? ' has-error' : '' }}">
                    ...
                    {!! Form::select('categories[]', $cat_select_array, null, ['class'=>'select2','multiple'=>'', 'required' => 'true']) !!}
        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_6_basic_pricing_title','Basic Pricing Title') !!}
                                                    {!! Form::text('pricing_detail_6[basic_pricing_title]', $basic_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Basic Pricing Title here', 'id'=>'pricing_detail_6_basic_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_6_price_basic','Basic Price in USD') !!}
                                                    {!! Form::number('pricing_detail_6[price_basic]', $price_basic, ['class'=>'form-control', 'placeholder'=>'Write your Basic Price in USD here', 'id'=>'pricing_detail_6_price_basic']) !!}
                                                    {!! Form::hidden('pricing_detail_6[pd_id_price_basic]', $pd_id_price_basic) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_6_basic_pricing_subtitle','Basic Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_6[subtitle][basic_pricing_subtitle]', $basic_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Basic Pricing Subtitle here', 'id'=>'pricing_detail_6_basic_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    {{----------------------------------------}}
                    <div class="div_package div_package_8">
                        <?php
                        $isPackageDetail8 = isset($package_info) && $package_info->type == 8 ? true : false;

                        $hasContentPlan1 = ($isPackageDetail8 && isset($package_info->content[0])) ? true : false;
                        $contentPlan1= ($hasContentPlan1) ? $package_info->content[0] : [];
                        $plan1_pricing_title = isset($contentPlan1->title) ? $contentPlan1->title : "PLAN 1";
                        $priceType = isset($contentPlan1->price_type) ? $contentPlan1->price_type : 5;
                        $price_plan1 = isset($contentPlan1->price) ? $contentPlan1->price : "";
                        $pd_id_price_plan1 = isset($contentPlan1->id) ? $contentPlan1->id : 0;

                        $subtitles = ($isPackageDetail8 && $package_info->pricing_detail != '') ? SM::sm_unserialize($package_info->pricing_detail) : array();
                        $plan1_pricing_subtitle = (isset($subtitles['plan1_pricing_subtitle'])) ? $subtitles['plan1_pricing_subtitle'] : "";
//                            ----Plan 2-------------
                        $hasContentPlan2 = ($isPackageDetail8 && isset($package_info->content[1])) ? true : false;
                        $contentPlan2 = ($hasContentPlan2) ? $package_info->content[1] : [];
                        $plan2_pricing_title = isset($contentPlan2->title) ? $contentPlan2->title : "PLAN 2";
                        $priceType = isset($contentPlan2->price_type) ? $contentPlan2->price_type : 5;
                        $price_plan2 = isset($contentPlan2->price) ? $contentPlan2->price : "";
                        $pd_id_price_plan2 = isset($contentPlan2->id) ? $contentPlan2->id : 1;

                        $subtitles = ($isPackageDetail8 && $package_info->pricing_detail != '') ? SM::sm_unserialize($package_info->pricing_detail) : array();
                        $plan2_pricing_subtitle = (isset($subtitles['plan2_pricing_subtitle'])) ? $subtitles['plan2_pricing_subtitle'] : "";
                        ?>

                        <div class=" smthemeoptionfield">
                            <div class="col-md-2">
                                {!! Form::label('pricing_detail_8_price_type','Pricing Types') !!}
                            </div>
                            <div class="col-md-9">
                                <div class="form-group">
                                    {!! Form::select('pricing_detail_8[price_type]', SM::packagePaymentType(), $priceType, ['class'=>'form-control','id'=>'pricing_detail_8_price_type']) !!}
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan1_pricing_title','Plan1 Pricing Title') !!}
                                                    {!! Form::text('pricing_detail_8[plan1_pricing_title]', $plan1_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan1 Pricing Title here', 'id'=>'pricing_detail_8_plan1_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan1','Plan1 Price in USD') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan1]', $price_plan1, ['class'=>'form-control', 'placeholder'=>'Write your Plan1 Price in USD here', 'id'=>'pricing_detail_8_price_plan1']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan1]', $pd_id_price_plan1) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan1_pricing_subtitle','Plan1 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan1_pricing_subtitle]', $plan1_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan1 Pricing Subtitle here', 'id'=>'pricing_detail_8_plan1_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan2_pricing_title','Plan 2 Pricing Title') !!}
                                                    {!! Form::text('pricing_detail_8[plan2_pricing_title]', $plan2_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan 2 Pricing Title here', 'id'=>'pricing_detail_8_plan2_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan2','Plan 2 Price in USD') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan2]', $price_plan2, ['class'=>'form-control', 'placeholder'=>'Write your Plan 2 Price in USD here', 'id'=>'pricing_detail_8_price_plan2']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan2]', $pd_id_price_plan2) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan2_pricing_subtitle','Plan 2 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan2_pricing_subtitle]', $plan2_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan 2 Pricing Subtitle here', 'id'=>'pricing_detail_8_plan2_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    $hasContentPlan3 = ($isPackageDetail8 && isset($package_info->content[2])) ? true : false;
                                    $contentPlan3 = ($hasContentPlan3) ? $package_info->content[2] : [];
                                    $plan3_pricing_title = isset($contentPlan3->title) ? $contentPlan3->title : "PLAN 3";
                                    $price_plan3 = isset($contentPlan3->price) ? $contentPlan3->price : "";
                                    $pd_id_price_plan3 = isset($contentPlan3->id) ? $contentPlan3->id : 0;
                                    $plan3_pricing_subtitle = (isset($subtitles['plan3_pricing_subtitle'])) ? $subtitles['plan3_pricing_subtitle'] : "";
                                    ?>
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan3_pricing_title','Plan 3 Pricing Title') !!}
                                                    {!! Form::text('pricing_detail_8[plan3_pricing_title]', $plan3_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan 3 Pricing Title here', 'id'=>'pricing_detail_8_plan3_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan3','Plan 3 Price in USD') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan3]', $price_plan3, ['class'=>'form-control', 'placeholder'=>'Write your Plan 3 Price in USD here', 'id'=>'pricing_detail_8_price_plan3']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan3]', $pd_id_price_plan3) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan3_pricing_subtitle','Plan 3 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan3_pricing_subtitle]', $plan3_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan 3 Pricing Subtitle here', 'id'=>'pricing_detail_8_plan3_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    $hasContentPlan4 = ($isPackageDetail8 && isset($package_info->content[3])) ? true : false;
                                    $contentPlan4 = ($hasContentPlan4) ? $package_info->content[3] : [];
                                    $plan4_pricing_title = isset($contentPlan4->title) ? $contentPlan4->title : "PLAN 4";
                                    $price_plan4 = isset($contentPlan4->price) ? $contentPlan4->price : "";
                                    $pd_id_price_plan4 = isset($contentPlan4->id) ? $contentPlan4->id : 0;
                                    $plan4_pricing_subtitle = (isset($subtitles['plan4_pricing_subtitle'])) ? $subtitles['plan4_pricing_subtitle'] : "";
                                    ?>
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan4_pricing_title','Plan 4 Pricing Title') !!}
                                                    {!! Form::text('pricing_detail_8[plan4_pricing_title]', $plan4_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan 4 Pricing Title here', 'id'=>'pricing_detail_8_plan4_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan4','Plan 4 Price in USD') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan4]', $price_plan4, ['class'=>'form-control', 'placeholder'=>'Write your Plan 4 Price in USD here', 'id'=>'pricing_detail_8_price_plan4']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan4]', $pd_id_price_plan4) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan4_pricing_subtitle','Plan 4 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan4_pricing_subtitle]', $plan4_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan 4 Pricing Subtitle here', 'id'=>'pricing_detail_8_plan4_pricing_subtitle1']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    $hasContentPlan5 = ($isPackageDetail8 && isset($package_info->content[4])) ? true : false;
                                    $contentPlan5 = ($hasContentPlan5) ? $package_info->content[4] : [];
                                    $plan5_pricing_title = isset($contentPlan5->title) ? $contentPlan5->title : "PLAN 5";
                                    $price_plan5 = isset($contentPlan5->price) ? $contentPlan5->price : "";
                                    $pd_id_price_plan5 = isset($contentPlan5->id) ? $contentPlan5->id : 0;
                                    $plan5_pricing_subtitle = (isset($subtitles['plan5_pricing_subtitle'])) ? $subtitles['plan5_pricing_subtitle'] : "";
                                    ?>
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan5_pricing_title','Plan 5 Pricing Title') !!}
                                                    {!! Form::text('pricing_detail_8[plan5_pricing_title]', $plan5_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan 5 Pricing Title here', 'id'=>'pricing_detail_8_plan5_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan5','Plan 5 Price in USD') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan5]', $price_plan5, ['class'=>'form-control', 'placeholder'=>'Write your Plan 5 Price in USD here', 'id'=>'pricing_detail_8_price_plan5']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan5]', $pd_id_price_plan5) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan5_pricing_subtitle','Plan 5 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan5_pricing_subtitle]', $plan5_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan 5 Pricing Subtitle here', 'id'=>'pricing_detail_8_plan5_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    $hasContentPlan6 = ($isPackageDetail8 && isset($package_info->content[5])) ? true : false;
                                    $contentPlan6 = ($hasContentPlan6) ? $package_info->content[5] : [];
                                    $plan6_pricing_title = isset($contentPlan6->title) ? $contentPlan6->title : "PLAN 6";
                                    $price_plan6 = isset($contentPlan6->price) ? $contentPlan6->price : "";
                                    $pd_id_price_plan6 = isset($contentPlan6->id) ? $contentPlan6->id : 0;
                                    $plan6_pricing_subtitle = (isset($subtitles['plan6_pricing_subtitle'])) ? $subtitles['plan6_pricing_subtitle'] : "";
                                    ?>
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan6_pricing_title','Plan 6 Pricing Title1') !!}
                                                    {!! Form::text('pricing_detail_8[plan6_pricing_title]', $plan6_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan 6 Pricing Title here1', 'id'=>'pricing_detail_8_plan6_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan6','Plan 6 Price in USD1') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan6]', $price_plan6, ['class'=>'form-control', 'placeholder'=>'Write your Plan 6 Price in USD here', 'id'=>'pricing_detail_8_price_plan6']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan6]', $pd_id_price_plan6) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan6_pricing_subtitle','Plan 6 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan6_pricing_subtitle]', $plan6_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan 6 Pricing Subtitle here1', 'id'=>'pricing_detail_8_plan6_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    $hasContentPlan7 = ($isPackageDetail8 && isset($package_info->content[6])) ? true : false;
                                    $contentPlan7 = ($hasContentPlan7) ? $package_info->content[6] : [];
                                    $plan7_pricing_title = isset($contentPlan7->title) ? $contentPlan7->title : "PLAN 7";
                                    $price_plan7 = isset($contentPlan7->price) ? $contentPlan7->price : "";
                                    $pd_id_price_plan7 = isset($contentPlan7->id) ? $contentPlan7->id : 0;
                                    $plan7_pricing_subtitle = (isset($subtitles['plan7_pricing_subtitle'])) ? $subtitles['plan7_pricing_subtitle'] : "";
                                    ?>
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan7_pricing_title','Plan7 Pricing Title') !!}
                                                    {!! Form::text('pricing_detail_8[plan7_pricing_title]', $plan7_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan7 Pricing Title here', 'id'=>'pricing_detail_8_plan7_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan7','Plan7 Price in USD') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan7]', $price_plan7, ['class'=>'form-control', 'placeholder'=>'Write your Plan7 Price in USD here', 'id'=>'pricing_detail_8_price_plan7']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan7]', $pd_id_price_plan7) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan7_pricing_subtitle','Plan7 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan7_pricing_subtitle]', $plan7_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan7 Pricing Subtitle here', 'id'=>'pricing_detail_8_plan7_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
                                    $hasContentPlan8 = ($isPackageDetail8 && isset($package_info->content[7])) ? true : false;
                                    $contentPlan8 = ($hasContentPlan8) ? $package_info->content[7] : [];
                                    $plan8_pricing_title = isset($contentPlan8->title) ? $contentPlan8->title : "PLAN 8";
                                    $price_plan8 = isset($contentPlan8->price) ? $contentPlan8->price : "";
                                    $pd_id_price_plan8 = isset($contentPlan8->id) ? $contentPlan8->id : 0;
                                    $plan8_pricing_subtitle = (isset($subtitles['plan8_pricing_subtitle'])) ? $subtitles['plan8_pricing_subtitle'] : "";
                                    ?>
                                    <div class="col-sm-3">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan8_pricing_title','Plan 8 Pricing Title1') !!}
                                                    {!! Form::text('pricing_detail_8[plan8_pricing_title]', $plan8_pricing_title, ['class'=>'form-control', 'placeholder'=>'Write your Plan 8 Pricing Title here1', 'id'=>'pricing_detail_8_plan8_pricing_title']) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_price_plan8','Plan 8 Price in USD1') !!}
                                                    {!! Form::number('pricing_detail_8[price_plan8]', $price_plan8, ['class'=>'form-control', 'placeholder'=>'Write your Plan 8 Price in USD here1', 'id'=>'pricing_detail_8_price_plan8']) !!}
                                                    {!! Form::hidden('pricing_detail_8[pd_id_price_plan8]', $pd_id_price_plan8) !!}
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="sm-form">
                                                    {!! Form::label('pricing_detail_8_plan8_pricing_subtitle','Plan 8 Pricing Subtitle') !!}
                                                    {!! Form::text('pricing_detail_8[subtitle][plan8_pricing_subtitle]', $plan8_pricing_subtitle, ['class'=>'form-control', 'placeholder'=>'Write your Plan 8 Pricing Subtitle here', 'id'=>'pricing_detail_8_plan8_pricing_subtitle']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        $pricing_info = ($isPackageDetail8 && isset($package_info->pricing_info)) ? $package_info->pricing_info : array();
                        SM::smAddablePopup($options, "pricing_info", "Pricing Info", $pricing_info, "pricing_detail_8", 1);
                        ?>
                    </div>
                </div>
            </div>
