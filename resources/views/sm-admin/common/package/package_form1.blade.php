            ...
            <div class="widget-body padding-10">
                <div class="row">
                    ...
                    <div class="div_package_1">
						...
						$advanced_pricing_title = ( isset( $pricing_detail['advanced_pricing_title'] ) ) ? $pricing_detail['advanced_pricing_title'] : "ADVANCE";
						SM::smText( [ "label" => "Advanced Pricing Title" ], "advanced_pricing_title", "Advanced Pricing Title", $advanced_pricing_title, "pricing_detail_1", 1 );
						$price_recommended = ( isset( $package_info->price_recommended ) ) ? $package_info->price_recommended : 0;
						SM::smNumber( [ "label" => "Advanced Price in USD" ], "price_recommended", "Advanced Price in USD", $price_recommended, "pricing_detail_1", 1 );



						$professional_pricing_title = ( isset( $pricing_detail['professional_pricing_title'] ) ) ? $pricing_detail['professional_pricing_title'] : "PROFESSIONAL";
                    ...
                    <div class="div_package_2">
						...
						if ( isset( $package_info->package_detail2 ) && count( $package_info->package_detail2 ) > 0 ) {
							...
							foreach ( $package_info->package_detail2 as $pd2 ) {
								...
								$pricing_content[ $loop ]["words"]         = $pd2->words;
