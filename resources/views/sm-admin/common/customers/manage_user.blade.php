                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                            ...
                            <table id="" class="table table-striped table-bordered sm_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                @include('sm-admin.common.customers.customers')
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th>Select</th>
                            ...
                            @include('sm-admin.common.common.pagination_links', ['smPagination'=>$users])
                        </div>
                        <!-- end widget content -->
...
UP TO 30% OFF</textarea>
                    ...
                    <div class="row">
                        @include('sm-admin/common/common/image_form',['header_name'=>'Offer Title', 'image'=>'', 'grid'=>'col-xs-12 col-sm-12 col-md-12'])
                    </div>
                </div>
