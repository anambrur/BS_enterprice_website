        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="sm-form{{ $errors->has('contact_person') ? ' has-error' : '' }}">
                            {!! Form::label('contact_person',__("Contact Person"))!!}
                            {!! Form::text('contact_person', null,['id'=>'contact_person','class'=>'form-control', 'placeholder'=>__("Contact Person")]) !!}
                    ...
                    <div class="col-sm-6">
                        <div class="sm-form{{ $errors->has('contact_mobile') ? ' has-error' : '' }}">
                            {!! Form::label('contact_mobile',__("Contact Mobile"))!!}
                            {!! Form::text('contact_mobile', null,['id'=>'contact_mobile','class'=>'form-control', 'placeholder'=>__("Contact Mobile")]) !!}
                    ...
                    <div class="col-sm-6">
                        <div class="sm-form{{ $errors->has('vat') ? ' has-error' : '' }}">
                            {!! Form::label('vat',__("VAT"))!!}
                            {!! Form::text('vat', null,['id'=>'vat','class'=>'form-control', 'placeholder'=>__("VAT")]) !!}
                            @if ($errors->has('vat'))
                                <span class="help-block">
...
?>
@include(('sm-admin/common/common/image_form'),['header_name'=>'Customer', 'image'=>$image])