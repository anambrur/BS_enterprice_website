        ...
        <div>
            ...
            <div class="widget-body padding-10">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        @include("sm-admin.common.common.title_n_slug", ['isEnabledSlug'=>true, 'table'=>'pages', 'name'=>'page_title'])
                    </div>
                    <div class="col-sm-12">
...
?>
@include('sm-admin/common/common/image_form',['header_name'=>'Page Banner',
'image'=>$image])
@include('sm-admin/common/common/meta_info',['header_name'=>'Page',
'width'=>'col-lg-12'])