                    ...
                    <div>
                        ...
                        <div class="widget-body table-responsive">
                            ...
                            <table id="manage_blog" class="table table-striped table-bordered data_table" width="100%">
                                ...
                                <tbody id="dataBody">
                                @include('sm-admin.common.order.orders')
                                </tbody>
                                <tfoot>
                                <tr>
                                    <th>ID</th>
                            ...
                            @include('sm-admin.common.common.pagination_links', ['smPagination'=>$all_order])
                        </div>
                        <!-- end widget content -->
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        @include('sm-admin/common/common/gallary_form',['header_name'=>'Mail Files', 'image'=>'', 'grid'=>'col-xs-12 col-sm-12 col-md-12'])
                    </div>
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        @include('sm-admin/common/common/gallary_form',[
