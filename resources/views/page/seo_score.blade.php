            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="page-level-score">
                        <h2 class="margin-bottom30">PAGE LEVEL SEO SCORE</h2>
                ...
                <div class="col-lg-6">
                    <div class="page-level-score">
                        <h2 class="margin-bottom30">PAGE LEVEL SPEED SCORE</h2>
                        <ul class="page-level-list clearfix margin-bottom45">
                            <li>
                                <span id="pageSpeed">
                                        <div class="loader"></div>
    ...
    <section class="page-lavel-anylist-score-sec common-section" id="seo-recommendation">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-4 text-center">
                        <h2>Page Level SEO Recommendations</h2>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <section class="seo-analyst website-analyst-sec common-section" id="seo-analyst">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-4 text-center">
                        <h2>Page Level SEO Speed Test</h2>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="single-analyst-item">
                                        <h2 class="margin-bottom45">LOAD TIME ANALYSIS</h2>
                                ...
                                <div class="col-sm-6">
                                    <div class="single-analyst-item">
                                        <h2 class="margin-bottom45">SIZE ANALYSIS</h2>
