...
@section("content")
	<?php
	$service_detail_mail_title = SM::smGetThemeOption( "service_detail_mail_title", "Hire Us<br>15 Day FREE Trial" );
	...
	$bannerImage = SM::smGetThemeOption( "service_detail_banner_image" );
	?>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <div class="hire-form">
                        ...
                        <div class="contact-submit-btn hire-form-btn">
                            <span></span><b></b>
                            <input value="send massage" type="submit">
                        </div>
