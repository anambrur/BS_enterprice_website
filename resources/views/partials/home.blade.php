                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">
                        <div class="icon-box text-center">
                            @isset($feature["feature_title"])
                                ...
                                @endisset
                                <h2>
                                    <a href="<?php echo isset( $feature["feature_link"] ) ? $feature["feature_link"] : "#" ?>">{{ $feature["feature_title"] }}</a>
                                </h2>
                            @endisset
                            @isset($feature["feature_description"])
                                <p>
                            ...
                            <div class="col-lg-6 wow fadeInUp" data-wow-duration="700ms" data-wow-delay="300ms">
                                <div class="icon-box-2">
                                    <h2>
                                        ...
                                        @endempty
                                        <a href="{!! isset($feature["feature_link"]) ? $feature["feature_link"] : "#" !!}">
...
<section class="common-section bg-black achivment-section">
                ...
                @empty(!$achievement_title && !$achievement_description)
                    <div class="section-title-2">
                        ...
                        @empty(!$achievement_description)
                            <h2>{!! strip_tags($achievement_description, "<br><span><i><b>") !!}</h2>
                        @endempty
                    </div>
                @endempty
    ...
    <div class="activity-img">
        <img src="{!! asset('/images/bg1.png') !!}" alt="{{ $achievement_title }}">
    </div>
</section>
<!--OUR ACHIVMENT END-->
<?php
                            ...
                            <div class="single-case">
                                <div class="home-blog-meta case-portfolio-meta">
                                    ...
                                    <h3 class="cases-title">
                                        <a href="{{ url("cases/detail/".$case->slug) }}">{{ $case->title }}</a>
                                    </h3>
                                </div>
                                <div class="case-img">
                                ...
                                <div class="swiper-slide">
                                    <div class="latest-blog">
                                        <div class="blog-top">
                                            ...
                                            <h2 class="blog-title"><a href="{!! $blogUrl !!}">
                                                    {!! $sdTitle  !!}
                                                </a>
                                            </h2>
											<?php
                            ...
                            <div class="swiper-slide" data-swiper-autoplay="2500">
                                <div class="col-lg-2">
                                    <div class="single-client">
                                        <a href="#"><img src="{!! SM::sm_get_the_src($logo, 170, 95) !!}" alt="brand"></a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
