...
<div class="successful-popup-wrap" id="newsletterPopUp" style="display: none">
    <div class="successful-popup">
        ...
        <h3 class="popup_title">Subscribe Successful</h3>
        <p class="popup_message">Congratulations! Doodle has been successfully activated and now you can get latest
            update</p>
...
<div class="successful-popup-wrap" style="display: none;">
    <div class="successful-popup">
        <a href="#" class="close-icon"><i class="fa fa-times-circle"></i></a>
        <img src="{{ asset('images/thanku.png') }}" alt="">
        <h3>Thank You!</h3>
                ...
                <div class="col-lg-3 col-sm-6">
                    <aside class="widget">
                        ...
                        <ul>
                            ...
                            <li><a href="{!! url("/services/detail/".$service->slug) !!}">{{ $service->title }}</a></li>
                            @endforeach
                        </ul>
                        @endif
                    </aside>
