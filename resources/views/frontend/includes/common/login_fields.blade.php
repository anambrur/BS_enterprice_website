...
<div class="form-input">
    <label for="login-email" class="requiredStar">Email Address</label>
    {!! Form::text("username",  null, ['required' => 'true']) !!}
    <span class="error-notice"></span>
</div>
<div class="form-input">
    <label for="login-password" class="requiredStar">Password</label>
...
<div class="clearfix">
    ...
    <a id="forgotPassBtn" class="forgot-pass pull-right" href="#">Forgot Your Password?</a>
</div>
