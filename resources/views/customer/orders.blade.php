                                ...
                                @foreach($orders as $order)
                                    <div class="single-order">
                                        <div class="order-head clearfix">
                                            <h5 class="pull-left1"><b>Order date:</b>
                                        ...
                                        <div class="order-content">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6"> 
                                                    <p><b>Order Total:</b> {{ SM::get_setting_value('currency') }} {{ number_format($order->net_total, 2) }}</p>
                                                    <!-- <p><b>Paid:</b> {{ SM::get_setting_value('currency') }} {{ number_format($order->paid, 2) }}</p> -->
													<?php
													...
													?>
                                                    @if($due <0 )
                                                        <!-- <p><b>Due:</b> {{ $dueSign }} {{ SM::get_setting_value('currency') }} {{ abs($due) }}</p> -->
                                                        <!-- <a href="{{ url("dashboard/orders/pay/$order->id") }}" class="btn btn-warning">Pay your Due -->
                                                        </a>
                                                    @endif
                                                    <div class="order-btn">
                                                        ...
                                                        <a class="reorder" title="View Invoice" target="_blank"
