...
(function ($) {
    ...
    if ($('.data_table, .sm_table').length > 0) {
        $('.data_table, .sm_table').on('change', '.change_status', function () {
            var status = $(this).val();
...
//      console.log(controller + ' ' + method);
    ...
    if ($('#nestable_main_menu').length > 0) {
        ...
        $('#add_custom_menu_button').on('click', function () {
            ...
            data += '<input class="form-control link" type="url" name="menu_item[' + item_l + '][link]" placeholder="Url like http://smddtech.com" value="' + add_custom_menu_link + '">';
            data += '</label>';
            data += '<label class="input">';
...
//               console.log(parent_id1 + ' set to ' + parent_id + ' new ' + $(this).children('.p_id').val());
        ...
        var _token = $('#table_csrf_token').val();
        var data = $('#nestable_main_menu > form').serialize() + '&' + $.param({'_token': _token});
    ...
    if ($('#sm_media_modal').length > 0) {
        ...
        $('.sm_media_modal_show').on('click', function () {
...
//            $('#' + img_holder + ' .media_img').attr('src', src);
    ...
    if ($('#first_ph').length > 0) {
        $('#first_ph').on('click', '.remove_img', function () {
